...
class CloudSecureWP_Waf_Rules {
	...
	private const WAF_RULES = array(
		...
		array(
			...
			'skipafter'        => '',
			'chain'            => false,
			'variables'        => array( 'request_filename', 'args_get', 'args_post', 'request_headers', 'xml' ),
			'remove_variables' => array( 'request_headers' => array( 'Referer' ) ),
			'attack'           => '',
		...
		array(
			...
			'skipafter'        => '',
			'chain'            => false,
			'variables'        => array( 'request_filename', 'args_get', 'args_post' ),
			'remove_variables' => array(),
			'attack'           => 1,
		...
		array(
			...
			'skipafter'        => '',
			'chain'            => false,
			'variables'        => array( 'args_get', 'args_post' ),
			'remove_variables' => array(),
			'attack'           => '',
		...
		array(
			...
			'variables'        => array( 'args_get', 'args_post' ),
			'remove_variables' => array(
				'args_get'  => array( 'wpsummary' ),
				'args_post' => array( 'wpsummary', 'post_content' ),
			),
			'attack'           => 8,
