...
class CloudSecureWP_Disable_Access_System_File_Rules {
	...
	private const DISABLE_ACCESS_SYSTEM_FILE_RULES = array(
		array(
			...
			'skipafter'        => '',
			'chain'            => false,
			'variables'        => array( 'request_filename', 'args_get', 'args_get_names', 'args_post', 'args_post_names', 'request_headers', 'xml' ),
		...
		array(
			...
			'skipafter'        => '',
			'chain'            => false,
			'variables'        => array( 'request_filename', 'args_get', 'args_get_names', 'args_post', 'args_post_names' ),
			'remove_variables' => array(),
			'attack'           => 1,
